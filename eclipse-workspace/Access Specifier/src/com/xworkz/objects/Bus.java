...
public class Bus {
	...
	private String name = "bmtc";
	private String brand = "Ic";
	long price = 64890;
	private String color = "green";
	private boolean numberPlate = true;
	boolean fuelType = true;
	boolean working = true;
	private String usedFor = "travelling";
	...
	void setFuelType(boolean fuelType) {
