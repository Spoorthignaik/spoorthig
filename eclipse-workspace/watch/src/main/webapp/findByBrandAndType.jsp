...
<h3 style="color: green;">Search By Brand And Type</h3>
	<h3>
		<span style="color: red;">${messege }</span>
	</h3>

	<form action="findByBrandAndType" method="post">

	Search by Brand And Type <input type="text"  placeholder="Enter the Brand" name="brand"  />
	...
	<c:forEach items="${dtobrand}" var="n">
	<tr>
	<td>${n.id}</td>
	<td>${n.brand}</td>
	<td>${n.color}</td>
